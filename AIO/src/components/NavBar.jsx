...
function NavBar() {
  ...
  onMount(() => {
    ...
    const unlistenMaximized = appWindow.onResized(async () => { 
        setIsMaximized(await appWindow.isMaximized());
    });
    ...
    <>
      ...
      <nav class="navbar" style={{ 'pointer-events': 'none' }}> 
        ...
        <div class="logo-container" id='1'>
          <img src="/src/assets/logo.png" alt="AIO" class="logo" style={{ 'pointer-events': 'auto' }} />
        </div>

        {/* 对话按钮 */}
        <A href="/chat" class="nav-item" title="对话" activeClass="active" style={{ 'pointer-events': 'auto' }}>
        ...
        {/* 设置按钮 */}
        <A href="/settings" class="nav-item" title="设置" activeClass="active" style={{ 'pointer-events': 'auto' }}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
