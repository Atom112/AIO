  ...
  return (
    ...
    >
      ...
      >
        ...
        <span class="flex-1" style={{ color: 'rgba(255,255,255,0.6)' }}>
        ...
        <Show
          ...
          fallback={
            <Show
              ...
              fallback={
                <span style={{ color: 'rgba(255,255,255,0.3)', 'font-style': 'italic' }}>
                  {t('chat.btw.awaitingAnswer')}
                </span>
              }
            >
              <span style={{ color: 'rgba(255,255,255,0.4)' }} class="animate-pulse">
                {t('chat.btw.thinking')}
              </span>
            </Show>
          }
