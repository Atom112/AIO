...
const CommandPalette: Component = () => {
  ...
  const scrollToSelected = () => {
    requestAnimationFrame(() => {
      const selected = listRef?.querySelector(
        '.flex items-center justify-between px-3 py-2 rounded-lg cursor-pointer transition-colors duration-100 gap-3.selected',
      ) as HTMLElement;
      ...
      >
        ...
        >
          ...
          <div class="flex items-center justify-center gap-4 px-4 pt-2 pb-2.5 border-t border-t-white/[0.04] text-[10px] text-white/20">
            ...
            <span>
              <kbd>Enter</kbd> {t('command.palette.hintRun')}
            </span>
            <span>
