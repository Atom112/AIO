...
const UserDropdown: Component<UserDropdownProps> = (props) => {
  ...
  const [imgSrc, setImgSrc] = createSignal(untrack(() => props.avatar));
  ...
  return (
    ...
    >
      ...
      >
        <div
          class="flex items-center gap-2.5 p-2.5 text-[13px] rounded-md transition-all text-white/70 hover:bg-pri-10 hover:text-white"
